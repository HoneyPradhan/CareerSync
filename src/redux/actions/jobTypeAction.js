...
export const jobTypeLoadAction = () => async (dispatch) => {
    ...
    try {
        const { data } = await axios.get('https://careersyncbe-1.onrender.com/api/type/jobs');
        dispatch({
...
export const createJobTypeAction = (jobtype) => async (dispatch) => {
    ...
    try {
        const { data } = await axios.post("https://careersyncbe-1.onrender.com/api/type/create", jobtype)
        dispatch({
